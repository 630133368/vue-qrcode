...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"b5c12f96-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/QrCode.vue?vue&type=template&id=e3f8766a&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('canvas',{ref:"canvas",staticClass:"vue-qrcode-canvas",attrs:{"width":_vm.config.width,"height":_vm.config.height + _vm.config.textConfig.textHeight}})])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/QrCode.vue?vue&type=template&id=e3f8766a&
...
// CONCATENATED MODULE: ./src/assets/qrcode.js
//---------------------------------------------------------------------
...
for (var qrcode_i = 0; qrcode_i < 8; qrcode_i++) {
  QRMath.EXP_TABLE[qrcode_i] = 1 << qrcode_i;
}

for (var qrcode_i = 8; qrcode_i < 256; qrcode_i++) {
  QRMath.EXP_TABLE[qrcode_i] = QRMath.EXP_TABLE[qrcode_i - 4] ^ QRMath.EXP_TABLE[qrcode_i - 5] ^ QRMath.EXP_TABLE[qrcode_i - 6] ^ QRMath.EXP_TABLE[qrcode_i - 8];
}

for (var qrcode_i = 0; qrcode_i < 255; qrcode_i++) {
  QRMath.LOG_TABLE[QRMath.EXP_TABLE[qrcode_i]] = qrcode_i;
} //---------------------------------------------------------------------
// QRPolynomial
//---------------------------------------------------------------------
...
/* harmony default export */ var assets_qrcode = (QRCode);
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/ts-loader??ref--13-3!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/QrCode.vue?vue&type=script&lang=ts&
...
function (_Vue) {
  ...
  function QrCode() {
    ...
    _this = _possibleConstructorReturn(this, getPrototypeOf_getPrototypeOf(QrCode).apply(this, arguments));
    _this.config = {
      width: 300,
      height: 300,
      background: '#fff',
  ...
  _createClass(QrCode, [{
    key: "watchBindValue",
    value: function watchBindValue(val, old) {
      this.canvasChange();
    }
  }, {
    key: "mounted",
    ...
    key: "downLoad",
    value: function downLoad(type, name) {
      var filType = this.filterFormat(type);
      var canvas = this.$refs.canvas;
      var dataUrl = canvas.toDataURL(filType);
      this.saveFile(dataUrl, name);
    }
  }, {
    key: "filterFormat",
    value: function filterFormat(type) {
      var res = '';
    ...
    value: function createCanvas() {
      ...
      var canvas = this.$refs.canvas;
      var qrcode = new assets_qrcode(this.config.typeNumber, this.config.correctLevel);
      ...
      var tileW = this.config.width / qrcode.getModuleCount();
      var tileH = this.config.height / qrcode.getModuleCount(); // draw in the canvas
    ...
    value: function createImg() {
      ...
      img.onload = function () {
        img.width = _this2.config.imgWidth;
        img.height = _this2.config.imgHeight;
        var y = (_this2.config.height - _this2.config.imgHeight) / 2;
        var x = (_this2.config.width - _this2.config.imgWidth) / 2;

        _this2.ctx.drawImage(img, x, y, _this2.config.imgWidth, _this2.config.imgHeight);
      };
    }
  }, {
    key: "createText",
    value: function createText() {
      this.ctx.font = "".concat(this.config.textConfig.fontSize, "px bold \u9ED1\u4F53");
      this.ctx.fillStyle = this.config.textConfig.color;
      this.ctx.textAlign = 'center';
      this.ctx.fillText(this.config.text, this.config.width / 2, this.config.height + this.config.textConfig.textHeight / 2, this.config.width);
    }
  }, {
    key: "canvasChange",
    value: function canvasChange() {
    ...
    value: function canvasRender() {
      this.config = _objectSpread({}, this.config, this.options);
      var canvas = this.$refs.canvas;
...
})], QrCodevue_type_script_lang_ts_QrCode.prototype, "options", void 0);

__decorate([Watch('options', {
  deep: true
})], QrCodevue_type_script_lang_ts_QrCode.prototype, "watchBindValue", null);
...
/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (components_QrCode);
